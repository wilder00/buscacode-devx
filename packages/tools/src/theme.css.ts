...
export const christmasLightValues: ThemeBase = {
  color: {
    ...
    disableDark: '#75715e', // Texto deshabilitado oscuro
    disableBase: '#eaeaea', // Fondo deshabilitado base
    disableSoft: '#f8f8ff' // Fondo deshabilitado suave
  }
}
...
export const christmasDarkValues: ThemeBase = {
  color: {
    ...
    disableDark: '#c9d1d9', // Texto deshabilitado claro
    disableBase: '#3e3d32', // Fondo deshabilitado base
    disableSoft: '#272822' // Fondo deshabilitado suave
  }
}
...
export const githubLightValues: ThemeBase = {
  color: {
    ...
    disableDark: '#57606a', // Texto deshabilitado oscuro
    disableBase: '#f6f8fa', // Fondo deshabilitado base
    disableSoft: '#ffffff' // Fondo deshabilitado suave
  }
}
...
export const githubDarkValues: ThemeBase = {
  color: {
    ...
    disableDark: '#8b949e', // Texto deshabilitado claro
    disableBase: '#161b22', // Fondo deshabilitado base
    disableSoft: '#0d1117' // Fondo deshabilitado suave
  }
}
